...
public class AvaliacaoActivity extends AppCompatActivity {
    ...
    private AvaliacaoActivity mAvaliacaoActivity = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Listar_Avaliacao = new Listar_Avaliacao(this, OrdenarAlunos.ordendarComNotas(mAtividade.getAlunos()));
